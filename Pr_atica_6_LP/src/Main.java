...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        while (menu != 4) {
            System.out.println("============= OPÇÕES DE TEXTO =============");
            ...
            switch (menu) {
                case 1:
                    ...
                    namePath = ler.next();
                    ManipuladorArquivo.CriarArquivo(namePath);
                    break;
                case 2:
                    ...
                    status=ler.next();
                    ManipuladorArquivo.Writer(titulo,objetivo,endereco,dataInicio,status);
                    break;
                case 3:

                    System.out.println("Escreva o nome do arquivo que voce deseja abrir: ");
                    namePath = ler.next();
                    ManipuladorArquivo.Reading(namePath);
                    break;
                case 4:
